...
<body>
    ...
    <main>
        <section class="contato">
            <form>
                <div class="titulo">
                    <img src="../imgs-register/logo.png" alt="Logo globalcode pequena" class="logo-titulo">
                    <h1>Registro</h1>
                </div>
                <div class="box-input">
                    <div class="input-single">
                        <input type="text" id="nome" class="input" autocomplete="off" required>
                        <label for="nome-box" class="label">Nome</label>
                    </div>
                    <div class="input-single">
                        <input type="text" id="email" class="input" autocomplete="off" required>
                        <label for="email-box" class="label">E-mail</label>
                    </div>
                    <div class="input-single">
                        <input type="password" id="senha" class="input" autocomplete="off" required>
                        <label for="senha-box" class="label">Senha</label>
                    </div>
                    <div class="input-single">
                        <input type="password" id="senhaVerif" class="input" autocomplete="off" required>
                        <label for="senha-box" class="label">Confirme sua senha</label>
                    </div>
                </div>
                <button id="btn-enviar" onclick="enviar(event)">Criar</button>
            </form>
        </section>
        <section class="bg-contato">
            <img src="../imgs-register/image.png" alt="Imagem ilustrativa para a pagina de contato">
        </section>
    </main>
