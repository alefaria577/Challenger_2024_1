...
<body>
    ...
    <main>
        ...
        <section class="container">
            <p class="txt-welcome">Bem-vindo ao quiz game da Fórmula E, onde a velocidade elétrica encontra a diversão!
            </p>
            <h1>A CORRIDA DO CONHECIMENTO SE INICIA, VAMOS LÁ! </h1>
            <button type="submit" onclick="quiz(event)" class="btn-start">Comece agora</button>
            <div class="questoes">
                <p>As respostas apareceram no fim do jogo.</p>
                <div id="box-questoes">
                    <!-- <p>1. Teste</p>
                    <p>2. Teste2</p>
                    <p>3. Teste3</p> -->
