            ...
            <div class="info-cards">
                <div class="card">
                    <div class="title-icon">
                        ...
                        <img src="../assets/icon-velocidad.png" alt="Icone de velocidade">
                    </div>
                    <p id="velocidade">210 KM/h</p>
                </div>
                <div class="card">
                    <div class="title-icon">
                        <h3>Potência Máxima</h3>
                        <img src="../assets/icon-potencia.png" alt="Icone de velocidade">
                    </div>
                    <p id="potencia">250 kW</p>
                </div>
                <div class="card">
                    <div class="title-icon">
                        <h3>Capacidade da Bateria</h3>
                        <img src="../assets/icon-capacidade.png" alt="Icone de velocidade">
                    </div>
                    <p id="capacidade">50 kWh</p>
                </div>
                <div class="card">
                    <div class="title-icon">
                        <h3>Temperatura da Bateria</h3>
                        <img src="../assets/icon-temperatura.png" alt="Icone de velocidade">
                    </div>
                    <p id="temperatura">60°C</p>
                </div>
                <div class="card">
                    <div class="title-icon">
                        <h3>Consumo de Energia</h3>
                        <img src="../assets/icon-consumo.png" alt="Icone de velocidade">
                    </div>
                    <p id="consumo">1.1 kWh/volta</p>
                </div>
                <div class="card">
                    <div class="title-icon">
                        <h3>PESO</h3>
                        <img src="../assets/icon-peso.png" alt="Icone de velocidade">
                    </div>
                    <p id="peso">350 g</p>
                </div>
            </div>
