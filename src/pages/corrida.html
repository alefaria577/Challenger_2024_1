...
<body>
    ...
    <main>
        <h1 class="titulo">Circuitos</h1>

        <div class="container">
            <section class="sec-cards">
                <div class="card">
                    <p class="txt">TEMPO</p>
                    <img src="../assets/relogio.png" alt="Icone de relogio">
                    <div class="info-card">
                        <p class="txt">12</p>
                        <span>HORAS</span>
                    </div>
                ...
                <div class="card">
                    <p class="txt">Competidores</p>
                    <img src="../assets/participantes.png" alt="Icone de relogio">
                    <div class="info-card">
                        <p class="txt">11</p>
                        <span>EQUIPES</span>
                    </div>
                ...
                <div class="card">
                    <p class="txt">MONO POSTOS</p>
                    <img src="../assets/carro-esporte.png" alt="Icone de relogio">
                    <div class="info-card">
                        <p class="txt">4</p>
                        <span>CARROS</span>
                    </div>
                ...
                <div class="card">
                    <p class="txt">KM/H</p>
                    <img src="../assets/velocimetro.png" alt="Icone de relogio">
                    <div class="info-card">
                        <p class="txt">300</p>
                        <span>KM/H</span>
                    </div>
            ...
            <iframe src="https://www.youtube.com/embed/-G9S-6z3Sdc?si=oDnFye4ILbYyEBko"
